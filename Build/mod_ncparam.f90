...
!
        integer  :: idgamt        ! Heat exchange velocity
        integer  :: idgams        ! Salt exchange velocity
        integer  :: idtbvs        ! Viscous sublayer temperature
        integer  :: idsbvs        ! Viscous sublayer salinity
...
!  analytical expression directory.
!
      Rdir="/scratch/dgwyther/romsIceShelf_drag081_testing3"
      Hdir="/scratch/dgwyther/romsIceShelf_drag081_testing3/ROMS/Include"
      Hfile="icetest.h"
      Adir="/scratch/dgwyther/romsIceShelf_drag081_testing3/ROMS/Functionals"
!
!-----------------------------------------------------------------------
